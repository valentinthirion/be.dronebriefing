...
<?php
	...
	$browser = new Browser();
	// test for iDevices
	if ($browser->getPlatform() == Browser::PLATFORM_IPHONE	OR $browser->getPlatform() == Browser::PLATFORM_IPOD OR $browser->getPlatform() == Browser::PLATFORM_IPAD)
		define("PLATFORM", "iOS");
	// test for Android
	else if ($browser->getPlatform() == Browser::PLATFORM_ANDROID)
		define("PLATFORM", "Android");
	// test if Mac
	else if ($browser->getPlatform() == Browser::PLATFORM_APPLE)
		define("PLATFORM", "Mac");
	// test if Windows
	else if ($browser->getPlatform() == Browser::PLATFORM_WINDOWS)
		define("PLATFORM", "PC_windows");
	// test if Linux
	else if ($browser->getPlatform() == Browser::PLATFORM_LINUX)
		define("PLATFORM", "PC_linux");
	else
